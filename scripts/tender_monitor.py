...
SERVICE_WORDS = (
    "вывоз мусор", "вывоз отход", "транспортирован", "утилизац",
    "строительн", "крупногабарит", "кгм", "контейнер", "отход", "мусор",
)
GEO_WORDS = (
    "одинцов", "московская область", "московской области", "москва",
...
def relevant(entry):
    ...
    return any(w in hay for w in SERVICE_WORDS) and any(w in hay for w in GEO_WORDS)
